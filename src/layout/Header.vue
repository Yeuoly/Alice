                    ...
                    <div class="left mr2 clickable">
                        <NButtonGroup>
                            <NBadge :value="unreadCount" :offset="[-8, 3]" :max="99">
                                <NButton circle text type="primary" class="pr3" @click="toMessages">
...
import { NLayoutHeader, NMenu, MenuOption, NPageHeader, NIcon, NAvatar, NDropdown, NButton, NInput, NButtonGroup, NBadge } from 'naive-ui'
import { computed, h, ref } from 'vue'
import { useI18n } from 'vue-i18n'
import { AddCircle, AddCircleOutline, DuplicateOutline, EnterOutline, LocationOutline, LogInOutline, Mail, MailOutline, ScanOutline, SearchCircleOutline } from '@vicons/ionicons5'
const { t: $t } = useI18n()
...
const optionsMenu = computed(() => {
    if(!UserOnline.value) {
        return [{
            ...
            // @ts-ignore
            icon: () => h(NIcon, { clsPrefix: 'ion', size: 20 }, { 
